...
enum { /* id's of standard controls */
  ...
  CAGD_LMB_FRENET_MENU,
  CAGD_LMB_OSCULATING_MENU,
  CAGD_LMB_TORSION_MENU,
  CAGD_LMB_SPHERE_MENU,
  CAGD_ANIM_FRENET_MENU,
  CAGD_ANIM_OSCULATING_MENU,
  CAGD_ANIM_TORSION_MENU,
  CAGD_ANIM_SPHERE_MENU,
  CAGD_SHOW_EVOLUTE_MENU,
  CAGD_SHOW_OFFSET_CURVE_MENU,
  CAGD_OFFSET_CURVE_VALUE_MENU,
  CAGD_LOWER_DOMAIN_MENU,
  CAGD_HIGHER_DOMAIN_MENU,
  CAGD_REDRAW_ALL,
  CAGD_X_PARAMETER_MENU,
  CAGD_Y_PARAMETER_MENU,
  CAGD_Z_PARAMETER_MENU
};
